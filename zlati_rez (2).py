...
def natancni_priblizek(a):
    k = 0
    while abs(priblizek(k) - naslednji_priblizek(priblizek(k))) > a:
        k += 1
    return naslednji_priblizek(priblizek(k))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTQ3NX0:1iM80f:zMeVQO5Ba4iTPb30wRbJ5maA6wY'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTQ3Nn0:1iM80f:G3lqa3Q0bfH_MBKE3zHGiubThxY'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTQ3N30:1iM80f:lHbbR5sbzacHZRdCyu71msnKU7Q'
        try:
