...
def stevilo_dni(mesec, leto):
    ...
    if 0 < mesec < 13:
        ...
        # raise ValueError("Month is too powerful")
        return 0
    if mesec != 2:
        return dni[mesec - 1]
    else:
...
def je_veljaven_datum(dan, mesec, leto):
    if dan <= stevilo_dni(mesec, leto) and stevilo_dni(mesec, leto) is not 0:
        return True
    else:
        return False
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTQwOX0:1iLtey:EMMawDCliH5_KZuGdDx-0d41t5w'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTQxMH0:1iLtey:Jux1UFU6Heb98EUElH8ni8_8rGU'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTQxMX0:1iLtey:4U5D-I5VHwRV6B-BOvIgYvSC0r8'
        try:
