...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTg4MCwidXNlciI6NDUwMH0:1iujvU:oPOQG74HMG3z6Y0Nsd7GVY8mvfs'
        try:
            test_cases = [
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTg4MSwidXNlciI6NDUwMH0:1iujvU:oyNRmsAkkSD3ZhZJhxDW6xyQsOI'
        try:
            test_cases = [
