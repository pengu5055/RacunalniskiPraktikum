...
#     True
# =============================================================================
def je_deljivo_s_katerim_od(n, t):
    for i in t:
        if n % i == 0:
            return True
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ0MSwidXNlciI6NDUwMH0:1iSoJQ:yxPaz8cdfG5K_wMluepsko121e4'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ0MiwidXNlciI6NDUwMH0:1iSoJQ:U9fRC02zjOksXgFa9JVqAywEVXA'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ0MywidXNlciI6NDUwMH0:1iSoJQ:-LsU3Uh_bp45oCGDu3WqCjTdrPc'
        try:
