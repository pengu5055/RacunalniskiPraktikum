...
#     False
# =============================================================================
def vsebuje_niz_z_vprasajem(tabela):
    return any(niz for niz in tabela for crka in niz if crka == "?")
# =====================================================================@021961=
# 3. podnaloga
...
#     False
# =============================================================================
def zgolj_dolge_besede(t, n):
    return len([value for value in t if len(value) >= n]) == len(t)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTk1OSwidXNlciI6NDUwMH0:1iTpu6:ZieSlSR25oIsRzVFXgXWEWZUR-M'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTk2MCwidXNlciI6NDUwMH0:1iTpu6:qX2eXUtbRFRJevcNOa9QS4i-OzM'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTk2MSwidXNlciI6NDUwMH0:1iTpu6:sUFMn_HmBF3M3pXZ31Bpix1U_Ks'
        try:
