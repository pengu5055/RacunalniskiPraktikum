...
#     ' * - * - * '
# =============================================================================
def odstrani_ponovljene_presledke(s):
    s = list(s)
    t = []
    prev = 0
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ0NCwidXNlciI6NDUwMH0:1iSoNU:V6ptQL03jPi4IR-O53Vf-Y0_iIg'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ0NSwidXNlciI6NDUwMH0:1iSoNU:ym2P00y0I0HFPo3lrmBE0yn0ciY'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ0NiwidXNlciI6NDUwMH0:1iSoNU:6oilWeOE_lOiTnqk9fd_lotd-zc'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ0NywidXNlciI6NDUwMH0:1iSoNU:MPnd8i4eSoaPwued78owbL2Es7c'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ0OCwidXNlciI6NDUwMH0:1iSoNU:KHVpvwHSzPn__wHcbtpMig15dZA'
        try:
