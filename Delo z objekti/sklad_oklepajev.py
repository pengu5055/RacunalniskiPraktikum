...
#     False
# =============================================================================
def naivna_resitev(str): # Spomni se da obstaja count() method in skri ta greh od kode
    o1 = 0
    o2 = 0
    o3 = 0
    c1 = 0
...
def gnezdeni_oklepaji(s):
    ...
    for i in range(len(s)):
        ...
        if x in c:
            try:
                if t[-1] == o[c.index(x)]: # Gleda zaklepaj
                    t.pop(-1)
            except IndexError:
                print("T is empty")
                return False
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTQ4Mn0:1iS4sg:vYq_EGWIEVE5GHiItqhGN-kFbc4'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTQ4M30:1iS4sg:Y0XiYDgZdjSlVYgEp16vRUix1u0'
        try:
