...
def najdaljse_zaporedje(m, n):
    ...
    length = {} # Pari dolzina zaporedja in index zaporedja
    for i in range(m, n+1):
        length[dolzina_zaporedja(i)] = i
    return max(length)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ2OCwidXNlciI6NDUwMH0:1iUGkl:_2RYNWRcTADRUvyssqO-6tuT-5w'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ2OSwidXNlciI6NDUwMH0:1iUGkl:IjyJI8p7-S9ld3rSRyGw610j4XY'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ3MCwidXNlciI6NDUwMH0:1iUGkl:i6Fd4BSahfVfWnXWZbX4G-5QFZo'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTQ3MSwidXNlciI6NDUwMH0:1iUGkl:FqfuMLlDKZXsaeyJz8fao71dLx4'
        try:
