...
# =============================================================================
def palindrom(niz):
    return niz == "".join(reversed(niz)) #niz[::-1] Ne pozabi na slicing
# =====================================================================@021906=
# 2. podnaloga
    ...
    if prakticno_palindrom(niz):
        ...
        for char in charlist:
            for j in range(len(niz)):
                if palindrom(niz[:j] + char + niz[j + 1:]):
                    return True
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTkwNSwidXNlciI6NDUwMH0:1iwqK7:zNeV62KAQI7M47nbn9yDHJh9rfQ'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTkwNiwidXNlciI6NDUwMH0:1iwqK7:CFih1UPbqyuundzkDr_ojCjSfUY'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTkwNywidXNlciI6NDUwMH0:1iwqK7:oG10DhjYH2vDjXwN35qDPTmv_sE'
        try:
