...
def je_ogrlica(niz, b, r):
    return b == niz.count("B") and r == niz.count('R') and not [l for l in list(niz) if l != 'R' and l != "B"]
# =====================================================================@021913=
# 2. podnaloga
...
def stevilo_ogrlic(b, r):
    ...
    if b == 0 or r == 0:
        ...
        stevilo = stevilo_ogrlic(b-1, r) + stevilo_ogrlic(b, r-1)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTkxMiwidXNlciI6NDUwMH0:1iwqnM:Fe0LRd3C9BUgFHIP_sAt5SvefCE'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJwYXJ0IjoyMTkxMywidXNlciI6NDUwMH0:1iwqnM:CUIjZ5tTBIKf9csqtN36uTUB8FE'
        try:
