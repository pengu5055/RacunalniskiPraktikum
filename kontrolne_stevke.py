...
def vsota_kvadratov_stevk(n):
    x = str(n)
    return int(x[0])**2 + int(x[1])**2 + int(x[2])**2
...
def _validate_current_file():
    ...
    if Check.part():
        ...
        try:
            Check.equal('vsota_kvadratov_stevk(123)', 0) #
            Check.equal('vsota_kvadratov_stevk(998)', 0) #
            Check.equal('vsota_kvadratov_stevk(111)', 0) #
            Check.equal('vsota_kvadratov_stevk(999)', 0) #
            Check.equal('vsota_kvadratov_stevk(321)', 0) #
            Check.equal('vsota_kvadratov_stevk(714)', 0) and \
            Check.equal('vsota_kvadratov_stevk(417)', 0) and \
            Check.equal('vsota_kvadratov_stevk(471)', 0) and \
            Check.equal('vsota_kvadratov_stevk(174)', 0) and \
            Check.equal('vsota_kvadratov_stevk(741)', 0) and \
            Check.equal('vsota_kvadratov_stevk(147)', 0) # vse tuki 66
        except:
    ...
    if Check.part():
        ...
        try:
            Check.equal('obrat(123)', 0)
            Check.equal('obrat(998)', 0)
            Check.equal('obrat(111)', 0)
            Check.equal('obrat(999)', 0)
            Check.equal('obrat(321)', 0)
            Check.equal('obrat(714)', 0) and \
            Check.equal('obrat(417)', 0) and \
            Check.equal('obrat(471)', 0) and \
            Check.equal('obrat(174)', 0) and \
            Check.equal('obrat(741)', 0) and \
            Check.equal('obrat(147)', 0)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
    ...
    if Check.part():
        ...
        try:
            Check.equal('dodaj_kontrolno_stevko(265195368523)', 0)
            Check.equal('dodaj_kontrolno_stevko(309763415292)', 0)
            Check.equal('dodaj_kontrolno_stevko(790490603490)', 0)
            Check.equal('dodaj_kontrolno_stevko(957800321625)', 0)
            Check.equal('dodaj_kontrolno_stevko(958811067176)', 0)
            Check.equal('dodaj_kontrolno_stevko(967881885905)', 0)
            Check.equal('dodaj_kontrolno_stevko(948946641471)', 0)
            Check.equal('dodaj_kontrolno_stevko(641602340292)', 0)
            Check.equal('dodaj_kontrolno_stevko(948666700540)', 0)
            Check.equal('dodaj_kontrolno_stevko(121679652819)', 0)
            Check.equal('dodaj_kontrolno_stevko(493557029514)', 0)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])
