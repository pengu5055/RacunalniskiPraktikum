...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTQ2Mn0:1iLw2c:9QTX43gbAIYeXlayORVBXtPQBVM'
        try:
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTQ2M30:1iLw2c:WgdOuA249lItSVBu7QylcEK-cb4'
        try:
            Check.equal('priblizek_do_natancnosti(2, 0.000001)', 0)
            Check.equal('priblizek_do_natancnosti(2, 0.01)', 0)
            Check.equal('priblizek_do_natancnosti(2, 0.00001)', 0)
            Check.equal('priblizek_do_natancnosti(3, 0.000001)', 0)
            Check.equal('priblizek_do_natancnosti(12345, 0.000001)', 0)
