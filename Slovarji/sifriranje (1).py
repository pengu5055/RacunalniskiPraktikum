...
# =============================================================================
def ali_je_sifra(s):
    return set(s.keys()) == set(s.values())
# =====================================================================@021508=
# 3. podnaloga
...
def odsifriraj(s, str):
    if not ali_je_sifra(s):
        return None
    else:
        inv = inverz(s)
        return sifriraj(inv, str)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTUwNn0:1iRGkC:YIDYjYPi62d6SH3g_8Mtj7IbLtc'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTUwN30:1iRGkC:_lDC6DsDROvxfGUIy1sxQXsqJh4'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTUwOH0:1iRGkC:lGGw-KE0kUwhv2uKcDgzwl-TOlA'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTUwOX0:1iRGkC:fwBofh0cPTCxb5Og1jldOH8-4z4'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
