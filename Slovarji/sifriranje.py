...
#     'UOČVUOČBI'
# =============================================================================
def sifriraj(nasa_sifra, str):
    t = []
    for i in str:
        t.append(nasa_sifra[i])
...
# =============================================================================
def ali_je_sifra(s):
    return len(s.keys()) == len(s.values())
# =====================================================================@021508=
# 3. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTUwNn0:1iRGFs:6YxdtFByJrizxja41n3wpYG1fM4'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTUwN30:1iRGFs:UctnHezkEPss62eEvzRywg8lZy8'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
            ...
            Check.equal("ali_je_sifra({'A': 'B', 'B': 'C'})", True)
            Check.equal("ali_je_sifra({'A': 'B', 'B': 'B', 'C': 'A'})", True)
            Check.equal("ali_je_sifra({'A': '1', 'B': '2', 'C': '3'})", True)
            Check.equal("ali_je_sifra({'A': 'B'})", True)
        except:
            Check.error("Testi sprožijo izjemo\n  {0}",
                        "\n  ".join(traceback.format_exc().split("\n"))[:-2])

    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTUwOH0:1iRGFs:4enRNI1YNM6VtE622qmdS_wQHnY'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
    ...
    if Check.part():
        Check.current_part['token'] = 'eyJ1c2VyIjo0NTAwLCJwYXJ0IjoyMTUwOX0:1iRGFs:wg6u59BYCLQR8IiHt0viYUPNT9s'
        try:
            nasa_sifra = {'Č': 'K', 'A': 'O', 'C': 'Z', 'B': 'M', 'E': 'V',
                          'D': 'C', 'G': 'P', 'F': 'E', 'I': 'B', 'H': 'F',
                          'K': 'I', 'J': 'A', 'M': 'U', 'L': 'H', 'O': 'R',
